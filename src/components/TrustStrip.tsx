...
const items = [
  { icon: Zap, label: "Avg delivery", value: "12s", color: "text-warning" },
  { icon: ShieldCheck, label: "Secured by", value: "M-Pesa", color: "text-primary" },
  { icon: Headphones, label: "Support", value: "24/7", color: "text-info" },
];
